...
INSERT INTO CUSTOMERS(CUST_FIRST_NAME, CUST_LAST_NAME, CUST_EMAIL, CUST_MESSAGE, CUST_INTENTION)
    VALUES ('Tester', 'Alpha', 'tester@pica.com', 'Mensagem de Tester', 'proposta'),
...
INSERT INTO CONTENT(GROUP_NAME, TITLE, LINK, TEXT, IS_EXTERNAL)
    VALUES ('header_buttons', 'header-action-button', '/work', 'Let`s work together', false),
        ('header_nav', 'header-action-button', '/login', 'Login', false);

-- Conteúdo: Template Footer
INSERT INTO CONTENT(GROUP_NAME, TITLE, LINK, TEXT, IS_EXTERNAL)
    VALUES ('footer_0', 'footer-link-credits', 'https://br.freepik.com/starline', 'Créditos ao plano de fundo', true),
...
VALUES ('hero_headtitle', 'hero-headtitle', 'Michel Camargo', false),
...
INSERT INTO CONTENT(GROUP_NAME, TITLE, LINK, TEXT, IS_EXTERNAL, IMG_SRC)
    VALUES ('social_links', 'social-linkedin', 'https://www.linkedin.com/in/michelscamargo/', 'LinkedIn', true, 'https://iili.io/XTRdgt.png'),
...
INSERT INTO PORTFOLIO(HEADING, SUBHEADING, DESCRIPTION, LINK)
    VALUES ('Villa Mercato', '', 'Solução e-commerce VTEX que consolida um conceito inovador em supermercados online', 'https://villamercato.com.br'),
